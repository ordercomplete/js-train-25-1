...
// Цикл while, що виводить значення з генератора, та працює поки генератор не вичерпаний.
while (!nextValue.done) {
  // Якщо властивість done == false, генератор має значення для повернення.
  console.log(nextValue.value);
  // Отримує нове значення з генератора
